...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#p16 {
	background:url("p16.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1189.521px;
	...
	#p30 {
	background:url("p30.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1476px;
	...
	#p29 {
	background:url("p29.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1194.479px;
	...
	#p20 {
	background:url("p20.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1481px;
	...
	#Badge_bj {
		...
		--web-action-target: Product_woody___1.jsp;
		cursor: pointer;
	}
	#METADATA_bk {
		display: none;
...
<div id="Product__woody">
	...
	<div id="n________________">
		<span>나무껍질, 목재 향기의 향<br/>자연스럽고 건조한 느낌의 특징<br/>나무의 고상하고 안정된 느낌을 주고<br/>따뜻하고 분위기가 있는 향</span>
	</div>
	<div id="METADATA">
	...
	<img id="p3" src="p3.png" srcset="p3.png 1x, p3@2x.png 2x">
		<button type="submit" id="p3" value = "<%=list.get(1).getFrag_num() %>" name = "frag"></button>
		
	<img id="p20" src="p20.png" srcset="p20.png 1x, p20@2x.png 2x">
		<button type="submit" id="p20" value = "<%=list.get(3).getFrag_num() %>" name = "frag"></button>
		
	<img id="p30" src="p30.png" srcset="p30.png 1x, p30@2x.png 2x">
		<button type="submit" id="p30" value = "<%=list.get(5).getFrag_num() %>" name = "frag"></button>
		
	<img id="p1" src="p1.png" srcset="p1.png 1x, p1@2x.png 2x">
		<button type="submit" id="p1" value = "<%=list.get(0).getFrag_num() %>" name = "frag"></button>
		
	<img id="p16" src="p16.png" srcset="p16.png 1x, p16@2x.png 2x">
		<button type="submit" id="p16" value = "<%=list.get(2).getFrag_num() %>" name = "frag"></button>
		
	<img id="p29" src="p29.png" srcset="p29.png 1x, p29@2x.png 2x">
		<button type="submit" id="p29" value = "<%=list.get(4).getFrag_num() %>" name = "frag"></button>
