...
<title>survey_1 – 1</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: survey_1 – 1;
		--web-view-id: survey_1__1;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: survey_1__1;
	}
	* {
		margin: 0;
		padding: 0;
...
<div id="survey_1__1">
	...
	<div id="n_______">
		<span>길을 걷다가 작은 카페에 들어갔습니다.<br/>음료를 하나 주문해주세요.</span>
	</div>
	<img id="americanojpg" src="americanojpg.png" srcset="americanojpg.png 1x, americanojpg@2x.png 2x">
		
	<img id="adejpg" src="adejpg.png" srcset="adejpg.png 1x, adejpg@2x.png 2x">
		
	<img id="mixjpg" src="mixjpg.png" srcset="mixjpg.png 1x, mixjpg@2x.png 2x">
		
	<img id="teajpg" src="teajpg.png" srcset="teajpg.png 1x, teajpg@2x.png 2x">
