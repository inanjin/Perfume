...
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: survey_1;
		--web-view-id: survey_1;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: survey_1;
	}
	* {
		margin: 0;
		padding: 0;
...
<div id="survey_1">
	...
	<div id="n________">
		<span>휴가 기간동안 여행을 계획하고 있습니다.<br/>선호하는 여행지를 골라주세요.</span><br/>
	</div>
	<img id="cafestreet" src="cafestreet.png" srcset="cafestreet.png 1x, cafestreet@2x.png 2x">
		
	<img id="party" src="party.png" srcset="party.png 1x, party@2x.png 2x">
		
	<img id="camping" src="camping.png" srcset="camping.png 1x, camping@2x.png 2x">
		
	<img id="flowers" src="flowers.png" srcset="flowers.png 1x, flowers@2x.png 2x">
	...
	<div id = "submit">
	<input type="submit" value="next" style=font-size:60px>
	</div>
	</form>
