...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#p18 {
	 background:url("p18.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 903px;
	...
	#p22 {
	 background:url("p22.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1189.521px;
	...
	#p39 {
	 background:url("p39.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1476px;
	...
	#p17 {
	 background:url("p17.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 908px;
	...
	#p34 {
	 background:url("p34.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1194.479px;
	...
	#p23 {
	 background:url("p23.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1481px;
...
<div id="Product__spicy">
	...
	<img id="p18" src="p18.png" srcset="p18.png 1x, p18@2x.png 2x">
		<button type="submit" id="p18" value = "<%=list.get(1).getFrag_num() %>" name = "frag"></button>
		
	<img id="p23" src="p23.png" srcset="p23.png 1x, p23@2x.png 2x">
		<button type="submit" id="p23" value = "<%=list.get(3).getFrag_num() %>" name = "frag"></button>
		
	<img id="p39" src="p39.png" srcset="p39.png 1x, p39@2x.png 2x">
		<button type="submit" id="p39" value = "<%=list.get(5).getFrag_num() %>" name = "frag"></button>
		
	<img id="p17" src="p17.png" srcset="p17.png 1x, p17@2x.png 2x">
		<button type="submit" id="p17" value = "<%=list.get(0).getFrag_num() %>" name = "frag"></button>
		
	<img id="p22" src="p22.png" srcset="p22.png 1x, p22@2x.png 2x">
		<button type="submit" id="p22" value = "<%=list.get(2).getFrag_num() %>" name = "frag"></button>
		
	<img id="p34" src="p34.png" srcset="p34.png 1x, p34@2x.png 2x">
		<button type="submit" id="p34" value = "<%=list.get(4).getFrag_num() %>" name = "frag"></button>
