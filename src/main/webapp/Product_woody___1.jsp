...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#p32 {
	background:url("p32.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 908px;
	...
	#p43 {
	background:url("p43.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1194.479px;
	...
	#p47 {
	background:url("p47.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 903px;
...
<div id="Product__woody__1">
	...
	<img id="p32" src="p32.png" srcset="p32.png 1x, p32@2x.png 2x">
		<button type="submit" id="p32" value = "<%=list.get(6).getFrag_num() %>" name = "frag"></button>
		
	<img id="p47" src="p47.png" srcset="p47.png 1x, p47@2x.png 2x">
		<button type="submit" id="p47" value = "<%=list.get(8).getFrag_num() %>" name = "frag"></button>
	...
	<button type="submit" id="p43" value = "<%=list.get(7).getFrag_num() %>" name = "frag"></button>
