...
<title>survey_3</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: survey_3;
		--web-view-id: survey_3;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: survey_3;
	}
	* {
		margin: 0;
		padding: 0;
...
<div id="survey_3">
	...
	<div id="n_______">
		<span>애인과 함께 영화를 보려고 합니다.<br/>장르를 하나 골라주세요.</span>
	</div>
	<img id="about" src="about.png" srcset="about.png 1x, about@2x.png 2x">
		
	<img id="n_07" src="n_07.png" srcset="n_07.png 1x, n_07@2x.png 2x">
		
	<img id="saw" src="saw.png" srcset="saw.png 1x, saw@2x.png 2x">
		
	<img id="dnd" src="dnd.png" srcset="dnd.png 1x, dnd@2x.png 2x">
