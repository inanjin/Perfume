...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#p48 {
	 background:url("p48.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1192px;
	...
	#p37 {
	 background:url("p37.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1481px;
	...
	#p12 {
	 background:url("p12.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 903px;
	...
	#p19 {
	 background:url("p19.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1192px;
	...
	#p51 {
	 background:url("p51.png") no-repeat;
		position: absolute;
		width: 202px;
		height: 206px;
		left: 1481px;
...
<div id="Product__citrus">
	...
	<img id="p9" src="p9.png" srcset="p9.png 1x, p9@2x.png 2x">
		<button type="submit" id="p9" value = "<%=list.get(0).getFrag_num() %>" name = "frag"></button>
		
	<img id="p19" src="p19.png" srcset="p19.png 1x, p19@2x.png 2x">
		<button type="submit" id="p19" value = "<%=list.get(2).getFrag_num() %>" name = "frag"></button>
	
	<img id="p48" src="p48.png" srcset="p48.png 1x, p48@2x.png 2x">
		<button type="submit" id="p48" value = "<%=list.get(4).getFrag_num() %>" name = "frag"></button>
		
	<img id="p12" src="p12.png" srcset="p12.png 1x, p12@2x.png 2x">
		<button type="submit" id="p12" value = "<%=list.get(1).getFrag_num() %>" name = "frag"></button>
	<img id="p37" src="p37.png" srcset="p37.png 1x, p37@2x.png 2x">
		<button type="submit" id="p37" value = "<%=list.get(3).getFrag_num() %>" name = "frag"></button>
	<img id="p51" src="p51.png" srcset="p51.png 1x, p51@2x.png 2x">
		<button type="submit" id="p51" value = "<%=list.get(5).getFrag_num() %>" name = "frag"></button>
	<%for(int i=0; i<6;i++){ %>
