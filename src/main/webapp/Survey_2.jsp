...
<title>survey_2</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: survey_2;
		--web-view-id: survey_2;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: survey_2;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Button {
		...
		--web-action-target: Main___1.html;
		cursor: pointer;
	}
	#METADATA_bj {
		display: none;
...
<body>
<div id="survey_2">
	<img id="n___114" src="n___114.png" srcset="n___114.png 1x, n___114@2x.png 2x">
	...
	<div id="n_______">
		<span>오늘은 당신의 생일입니다.<br/>가장 받고 싶은 선물을 골라주세요.</span>
	</div>
	<img id="flowerr" src="flowerr.png" srcset="flowerr.png 1x, flowerr@2x.png 2x">
		
	<img id="moneyjpg" src="moneyjpg.png" srcset="moneyjpg.png 1x, moneyjpg@2x.png 2x">
		
	<img id="cakejpg" src="cakejpg.png" srcset="cakejpg.png 1x, cakejpg@2x.png 2x">
		
	<img id="watchjpg" src="watchjpg.png" srcset="watchjpg.png 1x, watchjpg@2x.png 2x">
	...
	<div id="submit">
	<input type="submit" value="NEXT" style=font-size:50px>
	</div>
	</form>
	<div onclick="application.goToTargetView(event)" id="Button">
		<div id="METADATA_bj">
			<span>{"config":{},"type":"Button","theme":"Base","nodeName":"Button","__plugin":"Mockup","__version":"1.4.13","__lastUpdate":"2022-02-08T05:31:53.879Z"}</span>
		</div>
		<svg class="Area">
			<rect id="Area" rx="0" ry="0" x="0" y="0" width="94" height="36">
			</rect>
		</svg>
		<div id="Label">
			<span>HOME</span>
		...
		<div id="Icon">
			<div id="METADATA_bn">
				<span>{"config":{},"type":"Icon","theme":"Base","nodeName":"Icon","__plugin":"Mockup","__version":"1.4.13","__lastUpdate":"2022-02-08T05:31:53.875Z"}</span>
			</div>
			<svg class="Area_bo">
				<rect id="Area_bo" rx="0" ry="0" x="0" y="0" width="20" height="20">
				</rect>
			</svg>
			<div id="Icon_bp">
